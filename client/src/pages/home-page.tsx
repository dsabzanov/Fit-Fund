          ...
          <div className="relative">
            ...
            <div className="container mx-auto px-4 sm:px-6 py-12 sm:py-24 text-center">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-8 max-w-4xl mx-auto">
                ...
                <div className="flex flex-col items-center p-6 rounded-lg bg-gradient-to-br from-primary/30 to-primary/50 backdrop-blur-sm border-2 border-primary/20 shadow-lg relative">
                  <div className="absolute top-0 right-0 -mt-2 -mr-2 bg-amber-500 text-white text-xs px-2 py-1 rounded-full font-bold">
                    Featured
                  </div>
                  <h3 className="text-xl sm:text-2xl font-bold mb-2 text-white flex items-center gap-2">
                  ...
                  <p className="text-white/90 text-base mb-2">
                    Summer Slim Down Challenge - 6% in 6 Weeks
                  </p>
                  <div className="bg-white/10 rounded-lg p-3 my-2 w-full">
                    ...
                    <div className="flex justify-between mb-2 text-white/90 text-sm">
                      ...
                      <span className="font-medium">14 people</span>
                    </div>
                    <div className="flex justify-between mb-2 text-white/90 text-sm">
                      <span>Starts:</span>
                      <span className="font-medium">In 3 days</span>
                    </div>
                    <div className="w-full bg-white/10 rounded h-2 mt-3">
                      <div className="bg-white h-2 rounded" style={{ width: "80%" }}></div>
                    </div>
                    <p className="text-xs text-white/80 text-right mt-1">80% full - 4 spots left!</p>
                  </div>
                  <div className="flex-grow" />
                  <Link href="/weekly-game">
                    <Button 
                      size="lg"
                      className="bg-white hover:bg-white/90 text-primary hover:text-primary/90 border-2 border-white/80 w-full sm:w-auto transition-colors mt-4"
                    >
